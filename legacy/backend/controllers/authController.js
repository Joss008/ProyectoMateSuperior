...
const login = async (req, res) => {
    ...
    try {
        ...
        const usuarios = await db.findUsuarios({ correo });
...
const register = async (req, res) => {
    ...
    try {
        ...
        const existentes = await db.findUsuarios({ correo });
        ...
        await db.insertUsuario({ correo, password: hashedPassword, rol: 'cliente' });
...
const resetPassword = async (req, res) => {
    ...
    try {
        ...
        const actualizado = await db.updateUsuario(usuarioId, { password: hashedPassword });
